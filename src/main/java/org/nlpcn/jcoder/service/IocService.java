...
public class IocService {
	...
	public String getIocInfo(String groupName) throws Exception {
		byte[] data2ZK = sharedSpaceService.getData2ZK(sharedSpaceService.GROUP_PATH + "/" + groupName + "/resoureces/ioc.js");
	...
	public void saveIocInfo(String groupName,String code) throws Exception {
		...
		fileInfo.setRelativePath("resoureces/ioc.js");

		sharedSpaceService.getZk().setData().forPath(sharedSpaceService.GROUP_PATH+"/"+groupName+"/resoureces/ioc.js", JSONObject.toJSONBytes(fileInfo));
