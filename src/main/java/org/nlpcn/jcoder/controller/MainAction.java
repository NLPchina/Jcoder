...
public class MainAction {
	...
	public Restful left() throws Exception {
		...
		for (String groupName : allGroups) {
			submenus.add(ImmutableMap.of("name",groupName,"url","/admin/task?name="+groupName)) ;
		}
		...
		for (String groupName : allGroups) {
			submenus.add(ImmutableMap.of("name",groupName,"url","/admin/jar?name="+groupName)) ;
		}
		...
		submenus = new JSONArray() ;
		for (String groupName : allGroups) {
			submenus.add(ImmutableMap.of("name",groupName,"url","/admin/resource?name="+groupName)) ;
		}
