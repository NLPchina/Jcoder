...
public class IocAction {
	...
	@Ok("jsp:/ioc.jsp")
	public String show(){
		return IOUtil.getContent(new File(StaticValue.HOME+"/ioc.js"), IOUtil.UTF8) ;
	}
	...
	public JsonResult save(@Param("code") String code){
		IOUtil.Writer(StaticValue.HOME+"/ioc.js", IOUtil.UTF8, code);
		Ioc ioc = new NutIoc(new JsonLoader(StaticValue.HOME+"/ioc.js"));
